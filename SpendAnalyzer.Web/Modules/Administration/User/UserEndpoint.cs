...
namespace SpendAnalyzer.Administration.Endpoints
{
    using Entities;
    using Repositories;
    using Serenity;
    ...
    public class UserController : ServiceEndpoint
    {
        ...
        //public string ProcessRequest(string requestData)
        {
            ...
            //SmoothDataProcessor.DataClientGeneratorSoapClient dcgsc = new SmoothDataProcessor.DataClientGeneratorSoapClient(SmoothDataProcessor.DataClientGeneratorSoapClient.EndpointConfiguration.DataClientGeneratorSoap, "http://rootsqrygen.azurewebsites.net/DataClientGenerator.asmx");
