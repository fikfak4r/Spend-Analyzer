...
namespace SpendAnalyzer.Administration.Entities
{
    ...
    public sealed class UserRow : LoggingRow, IIdRow, INameRow, IIsActiveRow
    {
        ...
        [DisplayName("Tenants"), Size(250)]
        public String Tenants
        {
            get { return Fields.Tenants[this]; }
            set { Fields.Tenants[this] = value; }
        }
